...
},{"./lib/server":2,"./lib/render-state":3,"game-shell":4}],2:[function(require,module,exports){
"use strict"
...
proto.setTickRate = function(rate) {
  this.tickRate = rate
  clearInterval(this.tickInterval)
  this.tickInterval = setInterval(this.tick.bind(this), rate)
  for(var i=0; i<this.clients.length; ++i) {
    this.clients[i].tickRate = rate
  }
}
...
proto.createClient = function(lag, x) {
  ...
  var client = new Client(this.tickCount, this.tickRate, fromClient, toClient)
...
},{"./client.js":5,"./trajectories.js":6,"./local-channel.js":7}],7:[function(require,module,exports){
"use strict"
...
},{"binary-search-bounds":22,"cubic-hermite":23}],21:[function(require,module,exports){
module.exports = require('./lib/pad')

},{"./lib/pad":24}],22:[function(require,module,exports){
"use strict"
